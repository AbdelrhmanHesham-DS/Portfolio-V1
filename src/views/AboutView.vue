<template>
  ...
  <div class="bg-[#0b0f1a] px-5 py-10 md:px-12 md:py-16 text-left text-gray-200 mx-3 mb-5 rounded-3xl border border-[#1e293b]">
    ...
    <section class="flex flex-col md:flex-row gap-6 md:gap-12">
      ...
      <div class="flex justify-center md:justify-start">
        <img
          src="/img/me.jpg"
          class="w-40 h-40 object-cover rounded-full border-4 border-[#38bdf8]"
        />
      </div>
      ...
      <div class="md:w-7/12 text-base md:text-lg text-slate-300">
        ...
        <p>
          ...
          <strong>Python</strong>, statistics, and modern analytics tools.
        </p>
  ...
  <div class="px-5 py-12 md:px-12 text-gray-200 mx-3">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-6 text-center">
      ...
      <div class="workflow-card">
        <h3>Data Cleaning</h3>
        <p>Handle missing values and prepare the dataset.</p>
      </div>

      <div class="workflow-card">
        <h3>Data Analysis</h3>
        <p>Explore trends and patterns in the data.</p>
      </div>

      <div class="workflow-card">
        <h3>Machine Learning</h3>
        <p>Train predictive models using ML algorithms.</p>
      </div>

      <div class="workflow-card">
        <h3>Deployment</h3>
        <p>Deploy models or dashboards for real use.</p>
      </div>
  ...
  <div class="px-5 py-10 md:px-12 md:py-16 text-left text-gray-200 mx-3">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
      ...
      <div
        ...
        :key="skill.id"
        class="bg-[#111827] border border-[#1e293b] rounded-xl p-4 flex items-center space-x-4 hover:border-[#38bdf8] transition"
      >
  ...
  <!-- CERTIFICATES -->
  <div id="certificates" class="px-5 py-10 md:px-12 text-gray-200 mx-3">
